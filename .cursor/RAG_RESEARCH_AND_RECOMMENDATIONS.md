...
**Key Finding**: Current implementation needs significant improvements. Recommended architecture uses hybrid retrieval, query intent classification, reranking, and specialized code chunking.
...
1. ✅ **Fix document retrieval first** (query intent, section-aware, synthesis)
2. ✅ **Use unified collection** with metadata filtering
3. ✅ **Function-level code chunking** with Tree-sitter
4. ✅ **Hybrid retrieval** (BM25 + Vector) with reranking
5. ✅ **Answer synthesis** for complete answers
6. ✅ **Phase the implementation** (docs first, then code, then optimization)

**Next Steps**:
1. Review this research document
2. Approve recommended architecture
3. Start Phase 1 implementation (fix document retrieval)
